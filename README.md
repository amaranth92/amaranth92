...
Web Programmer with 6+ years of experience in Java/Spring-based enterprise web systems.
...
- Java/Spring backend and enterprise web development
- SQL database integration, query work, and batch data handling
- Maintenance, deployment support, and operational stability
- Mobile-first side projects and lightweight product experiments

## Tech

Java, Spring Boot, JSP, Servlet, MyBatis, React, JavaScript, jQuery, Ajax, Thymeleaf, WebSquare, MSSQL, Oracle, PostgreSQL, AWS, Jenkins, GitHub, Jira, IntelliJ, Python, Linux, ffmpeg, Selenium.
